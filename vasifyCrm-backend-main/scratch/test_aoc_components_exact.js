...
async function testExactComponents() {
  ...
  const testCases = [
    ...
    {
      desc: '2. components: [ { type: "body", parameters: ["v1", "v2", "v3", "v4"] } ]',
      payload: {
        from, to: recipient, type: 'template',
        templateName: 'invoice_ready_notification',
        language: 'en',
    ...
    {
      desc: '3. components: [ { type: "body", parameters: [ { type: "text", text: "v1" }, ... ] } ]',
      payload: {
        from, to: recipient, type: 'template',
        templateName: 'invoice_ready_notification',
        language: 'en',
    ...
    {
      desc: '4. components: [ { type: "body", parameters: [ { text: "v1" }, ... ] } ]',
      payload: {
        from, to: recipient, type: 'template',
        templateName: 'invoice_ready_notification',
        language: 'en',
        components: [
          {
            type: 'body',
            parameters: vars4.map(t => ({ text: t }))
          }
        ]
      }
    },
    {
      desc: '5. components: [ { type: "body", variables: ["v1", "v2", "v3", "v4"] } ]',
      payload: {
        from, to: recipient, type: 'template',
        templateName: 'invoice_ready_notification',
        language: 'en',
    ...
    {
      desc: '6. components: { body: ["v1", "v2", "v3", "v4"] }',
      payload: {
        from, to: recipient, type: 'template',
        templateName: 'invoice_ready_notification',
        language: 'en',
